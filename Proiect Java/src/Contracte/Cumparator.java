...
/*
    Cumparatorul cumpara cu monede, orice animal.
    Daca se specifica animalul, i se ofera tipul de animal cu pretul cel mai mare, dar mai mic decat suma lui.
*/

public class Cumparator implements Contract {
    ...
    public Cumparator(){}
    public Cumparator(String nume, String CNP, int zi, int luna, int an, double suma, Animal animal)
    {
        this.nume = nume;
        this.CNP = CNP;
        this.zi = zi;
